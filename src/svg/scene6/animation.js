...
export default {
  ...
  initClickEvents (site) {
    document.querySelector('#email').addEventListener('click', () => {
      window.open('mailto:ronakpatil9@gmail.com')
    })

    document.querySelector('#medium').addEventListener('click', () => {
      window.open('https://www.linkedin.com/in/ronakpatil9/')
    })

    document.querySelector('#linkedin').addEventListener('click', () => {
      window.open('https://www.linkedin.com/in/ronakpatil9/', '_blank')
    })

    document.querySelector('#githubsite').addEventListener('click', () => {
      window.open('https://github.com/ronakpatil', '_blank')
    })

    document.querySelector('#instagram').addEventListener('click', () => {
      window.open('http://www.instagram.com/ronakpatilmemories', '_blank')
    })

    document.querySelector('#twitter').addEventListener('click', () => {
      window.open('https://twitter.com/bitter_twits', '_blank')
    })
